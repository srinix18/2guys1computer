...
# Example usage
input_file = 'test.txt'  # Text file
output_file = 'output.bin'  # Binary output file
...
binary_file_path = '/content/encrypted.bin'  # Path to your binary data file
output_image_path = 'output_image_with_hidden_data.png'  # Path for the output image with hidden data
...
# Example usage
image_path = 'output_image_with_hidden_data.png'  # Path to the image file with hidden data
output_binary_file = 'extracted_data1.bin'  # Output binary file to store the extracted data
...
def binary_to_text(input_binary_file, output_text_file):
    ...
    # Write the Base64 encoded data to the output text file
    with open(output_text_file, 'w') as f:
        f.write(base64_data.decode('utf-8'))

# Example usage
input_binary_file = '/content/decrypted_data.bin'  # Binary input file
output_text_file = 'text_data.txt'  # Output text file
